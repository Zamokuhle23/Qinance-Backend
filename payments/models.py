...
class Merchant(models.Model):
    ...
    pending_profile_changes = models.JSONField(default=dict, blank=True)
...
class MerchantLoan(models.Model):
    ...
    advisory_status = models.CharField(max_length=20, default='queued')
    advisory_result = models.JSONField(default=dict, blank=True)
    offer_status = models.CharField(max_length=20, default='awaiting_admin')
    offer_minimum = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'))
    offer_maximum = models.DecimalField(max_digits=12, decimal_places=2, default=Decimal('0.00'))
